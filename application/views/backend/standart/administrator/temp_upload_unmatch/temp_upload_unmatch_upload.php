...
jQuery.each(jQuery('#csv_file')[0].files, function(i, file) {
    data.append('file-'+i, file);
		...
		$.ajax({
			url:"<?php echo base_url(); ?>administrator/temp_upload_unmatch/import",
			method:"POST",
            data: data,
            dataType: 'json',
...
// ============
        ...
        // $.ajax({
        //   url: BASE_URL + '/administrator/temp_upload_unmatch/upload_save',
        //   type: 'POST',
        //   dataType: 'json',
        //   data: data_post,
        // })
...
// ================
$('#form_temp_upload_unmatch').on('submit', function(event){
