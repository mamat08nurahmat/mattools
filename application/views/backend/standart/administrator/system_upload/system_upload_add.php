                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <b>Input File type</b> CSV(coma delimeter)</small>
                            </div>
                        </div>
                                                 
                                                <div class="form-group ">
                            <label for="application_source" class="col-sm-2 control-label">JENIS FILE 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="application_source" id="application_source" data-placeholder="Select Application Source" >
                                    ...
                                    <option value="MISMER_UNMATCH">MISMER UNMATCH</option>
                                    </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="batch_id" id="batch_id" placeholder="Batch Id" value="<?= db_get_auto_increment('system_upload'); ?>">
                                <small class="info help-block">
