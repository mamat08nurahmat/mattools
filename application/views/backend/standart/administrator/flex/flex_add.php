...
<section class="content-header">
    <h1>
        Flex        <small><?= cclang('new', ['Flex']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Flex']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_flex', 
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="flex_file_galery_listed"></div>
...
<!--
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="download_at"  id="download_at">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
-->
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" name="uploader" id="uploader" placeholder="Uploader" value="<?= $_SESSION['id']; ?>">
<!--
...
<!--
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="is_download" id="is_download" placeholder="Is Download" value="<?= set_value('is_download'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/flex/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            ...
            $('.message').fadeIn();
            resetForm();
            $('#flex_file_galery').find('li').each(function() {
               $('#flex_file_galery').fineUploader('deleteFile', $(this).attr('qq-file-id'));
            });
