...
<section class="content-header">
    <h1>
        Temp Upload Mismer        <small><?= cclang('new', ['Temp Upload Mismer']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Temp Upload Mismer']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="IS_MATCH" id="IS_MATCH" placeholder="IS MATCH" value="<?= set_value('IS_MATCH'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/temp_upload_mismer/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
