...
// Generate 1
      $('.btn_generate1').click(function(event){
		...
		$.ajax({
			...
			url:'<?= site_url('administrator/mismer_detail/get_generate1/') ?>'+month+'/'+year,
			// method:"POST",
            // data: data,
            // dataType: 'html',
...
var url='<?= site_url('administrator/mismer_detail/getModalResult2/') ?>'+dataTahun+'/'+dataBulan+'/'+Wilayah;
...
//  var url='<?= site_url('administrator/report/getModal/') ?>'+dataTahun+'/'+dataBulan+'/'+Wilayah;
var url='<?= site_url('administrator/mismer_detail/get_export1/') ?>'+dataBulan+'/'+dataTahun;
...
$.ajax({
    // url:"<?php echo base_url(); ?>administrator/system_flpp/import_batch/"+batch_id+"/"+month+"/"+year,
    url:'<?= site_url('administrator/mismer_detail/get_generate2/') ?>'+tgl_awal+'/'+tgl_akhir,
    // method:"POST",
    // data: data,
    // dataType: 'html',
    // // data:new FormData(this),
...
var url='<?= site_url('administrator/mismer_detail/getModalResult1/') ?>'+TglAwal+'/'+TglAkhir+'/'+Wilayah;
...
//  var url='<?= site_url('administrator/report/getModal/') ?>'+dataTahun+'/'+dataBulan+'/'+Wilayah;
var url='<?= site_url('administrator/mismer_detail/get_export2/') ?>'+TglAwal+'/'+TglAkhir;
window.location.href = url;
// $('#result1').load(url);
