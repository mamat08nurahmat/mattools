    ...
    <div class="panel with-nav-tabs panel-default">
                ...
                <div class="panel-heading">
                        ...
                        <!-- NAV TAB -->
                            ...
                            <li><a href="#tab3default" data-toggle="tab">Unmatch</a></li>
                        <!-- /NAV TAB -->        	
                        </ul>
                </div>
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Mismer EDC Unmatch</h3>
                            <h5 class="widget-user-desc">By Date</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<div class="form-group ">
                            ...
                            <select name="year3" id="year3" class="form-control">
                            <!-- <option value="2017">2017</option> -->
                            <option value="2018">2018</option>
                            <option value="2019">2019</option>
                            </select>
                            ...
                            <div class="col-sm-2">
                                <a class="btn btn-flat btn-info btn_download1 btn_action btn_download1_back" id="btn_download1" data-stype='back' title="<?= cclang('save_and_go_the_list_button'); ?> (Ctrl+d)">
                                Download</a>
                                <small class="info help-block">
                                <b>*</b></small>                                
                            </div>
...
// ====export edcu nmatch
//export excel get_generate1
$(document).on('click', '#btn_download1', function (e) {

console.log('klikkkkk');
        let month3 = document.getElementById('month3').value;
...
//  var url='<?= site_url('administrator/report/getModal/') ?>'+dataTahun+'/'+dataBulan+'/'+Wilayah;
var url='<?= site_url('administrator/edc_detail/get_export_edc_unmatch/') ?>'+year3+'/'+month3;
window.location.href = url;
// $('#result3').load(url);
