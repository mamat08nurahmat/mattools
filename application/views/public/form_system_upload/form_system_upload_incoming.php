...
<!-- <div class="form-group ">
 ...
 <!--INCOMING  -->
<input type="hidden" name="application_source" id="application_source" value="INCOMING">
 <!--INCOMING  -->
...
<!-- HIDDEN -->
<input type="hidden" class="form-control" name="batch_id" id="batch_id" value="<?=db_auto_increment('form_system_upload')?>"  >
<!-- HIDDEN -->
