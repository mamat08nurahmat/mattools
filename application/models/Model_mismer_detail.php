...
class Model_mismer_detail extends MY_Model {
	...
	public function count_all($q = null, $field = null)
	{
        ...
        if (empty($field)) {
	        foreach ($this->field_search as $field) {
	            if ($iterasi == 1) {
	                $where .= "mismer_detail.".$field . " LIKE '%" . $q . "%' ";
	            } else {
	                $where .= "OR " . "mismer_detail.".$field . " LIKE '%" . $q . "%' ";
	            }
	            $iterasi++;
	        }
	...
	public function get($q = null, $field = null, $limit = 0, $offset = 0, $select_field = [])
	{
        ...
        $this->db->order_by('mismer_detail.'.$this->primary_key, "DESC");
		$query = $this->db->get($this->table_name);
...
/* End of file Model_mismer_detail.php */
/* Location: ./application/models/Model_mismer_detail.php */